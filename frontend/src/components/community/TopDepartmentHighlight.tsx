...
export default function TopDepartmentHighlight() {
  return (
    <section className="rounded-xl border-2 border-[#2F8D46] dark:border-[#22C55E] bg-[#F0FDF4] dark:bg-[rgba(34,197,94,0.15)] p-4 sm:p-5 transition-colors duration-200">
